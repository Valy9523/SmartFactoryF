		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-bottom">
				...
				<div class="col-sm-8 men-wear-right">
					...
					<p>在我国宏观经济环境运行平稳的大前提下，去年9月底以前量化宽松政策使得房地产行业去库存效果显著，房产配套需求突增使得热水器市场扩容；此外，二胎政策放开、城镇化水平提高、电商下乡的推行给行业注入了增长活力；最为关键的是，热水器市场需求逐迈向高端智能化，市场二次置换需求提高也成为热水器行业稳步增长不可或缺的因素。</p>
				</div>
				<div class="clearfix"></div>
			</div>
